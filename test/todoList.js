...
describe('todoList', function() {
  ...
  it('should not be able to create list without name', async () => {
    await expectRevert(todoList.createList(''), 'name is not valid');
  });
  ...
  it('should be able to create and update list as listowner', async () => {
    ...
    expect(await todoList.getList(listIds[0]))
  ...
  it('should not be able to delete list as foreign', async () => {
    ...
    await expectRevert(todoList.deleteList(listIds[0], { from: user1 }), 'you are not allowed to do that');
  });
  ...
  it('should be able to create todo', async () => {
    ...
    expect(await todoList.getTodo(listIds[0], 0))
  ...
  it('should not be able to delete todo as foreigner', async () => {
    ...
    await expectRevert(todoList.deleteTodo(listIds[0], 0, { from: user3 }), 'you are not allowed to do that.');
  });
